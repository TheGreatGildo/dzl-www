...
import DieselAbi from "./abi/diesel.json";
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.diesel = new this.web3.eth.Contract(DieselAbi);
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.diesel, contractAddresses.diesel[networkId])
  ...
  setDefaultAccount(account) {
    ...
    this.diesel.options.from = account;
  }
